...
<div class="main">
    <div class="back"><a href="forum.php">home</a> > <?php echo $post['title']; ?></div><br>
    <br>
    <div class="btn-group" class="pagination">
        <?php if ($page > 1) : ?>
            <a class="btn btn-secondary" href="view_post.php?id=<?php echo $post_id; ?>&page=<?php echo $page - 1; ?>">&lt; Prev</a>
        <?php endif; ?>

        <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
            <a class="btn btn-secondary" href="view_post.php?id=<?php echo $post_id; ?>&page=<?php echo $i; ?>" <?php if ($i == $page) echo ' class="active"'; ?>><?php echo $i; ?></a>
        <?php endfor; ?>

        <?php if ($page < $total_pages) : ?>
            <a class="btn btn-secondary" href="view_post.php?id=<?php echo $post_id; ?>&page=<?php echo $page + 1; ?>">Next &gt;</a>
        <?php endif; ?>
    </div>
    <br>
...
<div class="main">
    ...
    <?php else : ?>
        <p>You need to <a href="login.php">Login</a> / <a href="register.php">Register</a> to add a comment.</p>
    <?php endif; ?>
</div>
